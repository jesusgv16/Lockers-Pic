...
void interrupt(){
   ...
   INTCON.INT0IF = 0; // Limpiar bandera de INT0
    ...
    if (ocupado[0]==1 && flag1==1 && S1==0)
       {
           Lcd_Cmd(_LCD_CLEAR);
           M1=1;
                while(S1==0)
                {
                  Lcd_out(1,1,"waiting door...");
                }
          Lcd_Cmd(_LCD_CLEAR);
       ...
       else if (ocupado[1]==1 && flag2==1 && S2==0)
       {
        Lcd_Cmd(_LCD_CLEAR);
        M2=1;
                while(S2==0)
       ...
       else if (ocupado[2]==1 && flag3==1 && S3==0)
       {
        Lcd_Cmd(_LCD_CLEAR);
        M3=1;
        while(S3==0)
       ...
       else if (ocupado[3]==1 && flag4==1 && S4==0)
       {
        Lcd_Cmd(_LCD_CLEAR);
        M4=1;
        while(S4==0)
       ...
       else if (ocupado[4]==1 && flag5==1 && S5==0)
       {
        Lcd_Cmd(_LCD_CLEAR);
        M5=1;
        while(S5==0)
       ...
       else if (ocupado[5]==1 && flag6==1 && S6==0)
       {
        Lcd_Cmd(_LCD_CLEAR);
        M6=1;
        while(S6==0)
       ...
       else if (ocupado[6]==1 && flag7==1 && S7==0)
       {
        Lcd_Cmd(_LCD_CLEAR);
        M7=1;
        while(S7==0)
       ...
       else if (ocupado[7]==1 && flag8==1 && S8==0)
       {
        Lcd_Cmd(_LCD_CLEAR);
        M8=1;
        while(S8==0)
       ...
       else if (ocupado[8]==1 && flag9==1 && S9==0)
       {
        Lcd_Cmd(_LCD_CLEAR);
        M9=1;
        while(S9==0)
...
void main() {
      ...
      LATB=LATC=0X00; //LIMPIA LATCH DEL PUERTO B
